...
const TooltipGuided = () => {
    return (
        <div>
            <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'end', marginLeft: '12px'}}>
                <h6 className="main" style={{marginTop: '0'}}>
                    <div className="wrapper">
                        <div className="tooltip-left tooltip-mobile" data-tooltip={tooltipText}>
